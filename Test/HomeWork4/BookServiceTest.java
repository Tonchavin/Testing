...
public class BookServiceTest {
    ...
    @Test
    void testBookServiceFindBookByAuthor() {
        when(bookRepository.findByAuthor("Author1")).thenReturn(new Book("1", "Book1", "Author1"));
        when(bookRepository.findByAuthor("Author2")).thenReturn(new Book("2", "Book2", "Author2"));

        Book book1 = bookService.findByAuthor("Author1");
        Book book2 = bookService.findByAuthor("Author2");
